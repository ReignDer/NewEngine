...
/*        ImGui_ImplDX12_Init(device.Get(),
        ...
        io.FontDefault = io.Fonts->AddFontFromFileTTF("SignEditor/assets/fonts/Cascadia Mono/static/CascadiaMono-Regular.ttf", 15.0f);
	}
...
/*	void ImGuiLayer::OnImGuiRender()
    ...
    void ImGuiLayer::SetDarkColoredTheme()
    {
